...
Future<_i1.GetIt> $configureDependencies(
  ...
  gh.lazySingleton<_i5.UsersOutputPort>(
      () => presentersModule.usersOutputPort());
  ...
  gh.lazySingleton<_i6.AppControlCubit>(() => blocModule.appControlCubit);
  gh.lazySingleton<_i6.CachedRouteDetailsPageCubit>(
      () => blocModule.cachedRouteDetailsPageCubit);
  gh.lazySingleton<_i6.CachedRouteMapPageCubit>(
  ...
  gh.lazySingleton<_i5.ErrorHandlerOutputPort>(() =>
      presentersModule.getErrorHandlerOutputPort(gh<_i6.AppControlCubit>()));
  ...
  gh.lazySingleton<_i5.GeopositionOutputPort>(
      () => presentersModule.geopositionPresenter(
            ...
            gh<_i6.CachedRouteMapPageCubit>(),
          ));
  ...
  gh.lazySingleton<_i5.RoutesOutputPort>(
      () => presentersModule.getRoutesOutputPort(
            ...
            gh<_i6.CachedRouteDetailsPageCubit>(),
            gh<_i6.CachedRouteMapPageCubit>(),
          ));
  ...
  gh.lazySingleton<_i7.AuthInterceptor>(
      () => dioModule.authInterceptor(gh<_i5.PreferencesRepository>()));
  ...
  gh.lazySingleton<_i8.Dio>(
    () => dioModule.prodDio(gh<_i7.AuthInterceptor>()),
    registerFor: {_prod},
  );
  gh.lazySingleton<_i8.Dio>(
    () => dioModule.dio(gh<_i7.AuthInterceptor>()),
    registerFor: {
      _test,
      _dev,
    },
  ...
  gh.lazySingleton<_i5.LogoutUseCase>(() => userUseCasesModule.logoutUseCase(
  ...
  gh.lazySingleton<_i5.GetCachedRouteDetailsUseCase>(
  ...
  gh.lazySingleton<_i6.CachedRouteDetailsPageController>(() =>
      controllersModule.cachedRouteDetailsPageController(
          gh<_i5.GetCachedRouteDetailsUseCase>()));
  gh.lazySingleton<_i6.ProfileTabController>(
      () => controllersModule.profileTabController(gh<_i5.LogoutUseCase>()));
  gh.lazySingleton<_i6.CachedRouteMapPageController>(
  ...
  gh.lazySingleton<_i5.GetUserSubscriptionStatusUseCase>(
  ...
  gh.lazySingleton<_i5.GetUserByEmailUseCase>(
      () => userUseCasesModule.getUserByEmailUseCase(
            gh<_i5.UsersRepository>(),
            gh<_i5.UsersOutputPort>(),
            gh<_i5.ErrorHandlerOutputPort>(),
          ));
...
class _$PresentersModule extends _i10.PresentersModule {}

class _$AutoRouterModule extends _i11.AutoRouterModule {}

class _$BlocModule extends _i12.BlocModule {}
